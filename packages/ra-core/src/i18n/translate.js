...
const translate = BaseComponent => {
    warning(
        ...
        `The translate function is an Higher Order Component and should not be called directly with a translation key. Use the translate function this HOC add to your component props instead:
